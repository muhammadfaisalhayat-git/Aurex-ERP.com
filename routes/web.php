...
// Activation Routes (Bypass auth to avoid redirect loops during initial setup)
...
Route::middleware(['auth', 'set.locale'])->group(function () {
    ...
    /*
     ...
     |--------------------------------------------------------------------------
     */
    Route::middleware(['can:view-user-management'])->prefix('acp')->name('acp.')->group(
        function () {
            ...
            // User Management
            Route::prefix('user-mgmt')->name('user-mgmt.')->group(
                function () {
                // Users
            ...
            Route::prefix('system')->name('system.')->group(
                ...
                // Deployments
                Route::get('deployments', [SettingController::class, 'index'])->name('deployments.index');
