            ...
            <div class="card h-100">
                ...
                <div class="card-body">
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-6">
                            <label class="text-muted small text-uppercase fw-bold d-block mb-1">Quantity / Unit</label>
                            <div class="h6 mb-0">
                                {{ number_format($order->quantity, 3) }}
                                <small class="text-muted">{{ $order->measurementUnit->name ?? '' }}</small>
                            </div>
                        </div>
                        <div class="col-6">
                            ...
                            <tbody>
                                @if(count($order->workOrders) > 0)
                                    @foreach($order->workOrders as $index => $wo)
                                        <tr>
                                            <td class="ps-3"><span class="badge rounded-pill bg-secondary">{{ $index + 1 }}</span>
                                            </td>
                                ...
                                @else
                                    <tr>
                                        <td colspan="5" class="text-center py-4 text-muted small">No operations defined for this
                                            order.</td>
                                    </tr>
                                @endif
                            </tbody>
