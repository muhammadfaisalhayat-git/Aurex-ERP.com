                ...
                <div class="d-flex justify-content-between align-items-start">
                    <div>
                        ...
                        <small class="text-success">
                            <i class="fas fa-arrow-up me-1"></i>{{ $widgetData['sales_today']['count'] }} {{ __('messages.invoices') }}
                        </small>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-start">
                    <div>
                        ...
                        <small class="text-muted">{{ $widgetData['sales_month']['count'] }} {{ __('messages.invoices') }}</small>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-start">
                    <div>
                        ...
                        <small class="text-muted">{{ __('messages.today') }}: {{ number_format($widgetData['tax_collected']['today'], 2) }}</small>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-start">
                    <div>
                        ...
                        <small class="text-warning">{{ number_format($widgetData['pending_invoices']['amount'], 2) }}</small>
                    </div>
                ...
                <div class="list-group list-group-flush">
                    ...
                    <div class="list-group-item d-flex justify-content-between align-items-center px-0">
                        <div>
                            ...
                            <small class="text-muted">{{ $customer->customer->code }}</small>
                        </div>
                ...
                <div class="list-group list-group-flush">
                    ...
                    <div class="list-group-item d-flex justify-content-between align-items-center px-0">
                        <div>
                            ...
                            <small class="text-muted">{{ number_format($product->total_qty, 2) }} {{ __('messages.units_sold') }}</small>
                        </div>
                        <span class="badge bg-success rounded-pill">{{ number_format($product->total_amount, 2) }}</span>
                    </div>
                    @empty
                    <div class="text-center text-muted py-4">
                        <i class="fas fa-inbox fa-2x mb-2"></i>
                ...
                <div class="row text-center">
                    ...
                    <div class="col-6">
                        <div class="p-3 bg-warning bg-opacity-10 rounded">
                            <h4 class="text-warning mb-1">{{ number_format($widgetData['returns_summary']['month_amount'], 2) }}</h4>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <a href="{{ route('inventory.transfer-requests.index') }}" class="d-flex align-items-center p-3 bg-light rounded text-decoration-none">
                ...
                <div class="table-responsive">
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <span class="badge bg-{{ $activity->action === 'delete' ? 'danger' : ($activity->action === 'create' ? 'success' : 'primary') }}">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="saveDashboardSettings()">{{ __('messages.save_changes') }}</button>
            </div>
        </div>
    </div>
</div>
