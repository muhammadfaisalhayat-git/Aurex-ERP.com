...
@section('title', __('messages.add_patient') . ' - ' . __('messages.healthcare_management'))
...
<div class="container-fluid px-4">
    <div class="mb-4">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">{{ __('messages.add_patient') }}</li>
            </ol>
        </nav>
    </div>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">{{ __('messages.add_patient') }}</h6>
        </div>
        <div class="card-body">
            <form action="{{ route('healthcare.patients.store') }}" method="POST">
                @csrf
                <div class="row mb-3">
                    <div class="col-md-6">
