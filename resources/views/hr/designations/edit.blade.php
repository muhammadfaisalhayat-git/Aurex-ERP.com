...
@section('content')
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1 class="h3">{{ __('messages.edit_designation') }}</h1>
                ...
                <form action="{{ route('hr.designations.update', $designation) }}" method="POST">
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            ...
                            <input type="text" name="code" class="form-control" value="{{ $designation->code }}" required>
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">{{ __('messages.name_en') }}</label>
                            <input type="text" name="name_en" class="form-control" value="{{ $designation->name_en }}"
                                required>
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">{{ __('messages.name_ar') }}</label>
                            <input type="text" name="name_ar" class="form-control" value="{{ $designation->name_ar }}">
                        </div>
                        <div class="col-md-12">
