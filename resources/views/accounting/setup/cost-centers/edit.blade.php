...
@section('content')
    <div class="page-header">
        <h1 class="page-title">Edit Cost Center</h1>
        <div class="page-actions">
            <a href="{{ route('accounting.gl.setup.cost-centers.index') }}" class="btn btn-outline-secondary">
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('accounting.gl.setup.cost-centers.update', $item) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="mb-3">
