...
@section('title', 'Edit Letter of Credit')

@section('content')
    <div class="page-header">
        <h1 class="page-title">Edit Letter of Credit</h1>
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('accounting.gl.setup.lcs.update', $item) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="mb-3">
                        ...
                        <div class="d-grid">
                            <button type="submit" class="btn btn-primary">Update LC</button>
                        </div>
                    </form>
                </div>
            </div>
