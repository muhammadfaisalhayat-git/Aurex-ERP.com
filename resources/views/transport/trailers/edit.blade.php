...
@section('title', __('messages.transport') . ' - ' . __('messages.edit_trailer'))

@section('content')
    <div class="page-header">
        <div>
            <h1 class="page-title">{{ __('messages.edit_trailer') }}: {{ $trailer->code }}</h1>
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('transport.trailers.update', $trailer) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="code" class="form-control @error('code') is-invalid @enderror"
                                    value="{{ old('code', $trailer->code) }}" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="plate_number"
                                    ...
                                    value="{{ old('plate_number', $trailer->plate_number) }}" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="trailer_type" class="form-select @error('trailer_type') is-invalid @enderror"
                                    ...
                                    <option value="Flatbed" {{ old('trailer_type', $trailer->trailer_type) == 'Flatbed' ? 'selected' : '' }}>Flatbed</option>
                                    <option value="Refrigerated" {{ old('trailer_type', $trailer->trailer_type) == 'Refrigerated' ? 'selected' : '' }}>Refrigerated</option>
                                    <option value="Tanker" {{ old('trailer_type', $trailer->trailer_type) == 'Tanker' ? 'selected' : '' }}>Tanker</option>
                                    <option value="Lowboy" {{ old('trailer_type', $trailer->trailer_type) == 'Lowboy' ? 'selected' : '' }}>Lowboy</option>
                                </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" step="0.01" name="capacity_kg"
                                    ...
                                    value="{{ old('capacity_kg', $trailer->capacity_kg) }}" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="driver_name"
                                    ...
                                    value="{{ old('driver_name', $trailer->driver_name) }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="driver_phone"
                                    ...
                                    value="{{ old('driver_phone', $trailer->driver_phone) }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="license_number"
                                    ...
                                    value="{{ old('license_number', $trailer->license_number) }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" name="license_expiry"
                                    ...
                                    value="{{ old('license_expiry', $trailer->license_expiry?->format('Y-m-d')) }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="status" class="form-select @error('status') is-invalid @enderror" required>
                                    <option value="available" {{ old('status', $trailer->status) == 'available' ? 'selected' : '' }}>{{ __('messages.available') }}</option>
                                    <option value="busy" {{ old('status', $trailer->status) == 'busy' ? 'selected' : '' }}>
                                        {{ __('messages.busy') }}</option>
                                    <option value="maintenance" {{ old('status', $trailer->status) == 'maintenance' ? 'selected' : '' }}>{{ __('messages.maintenance') }}</option>
                                    <option value="retired" {{ old('status', $trailer->status) == 'retired' ? 'selected' : '' }}>{{ __('messages.retired') }}</option>
                                </select>
