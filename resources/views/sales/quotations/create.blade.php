            ...
            function addItem(data = null) {
                ...
                tr.innerHTML = `
                    ...
                    <td>
                        ...
                        <input type="hidden" name="items[${index}][tax_amount]" class="tax-amount-input" value="0">
                    </td>
                    <td>
                        <input type="number" step="0.01" class="form-control form-control-sm total-input bg-white" name="items[${index}][net_amount]" readonly value="0">
                    </td>
                ...
                // Event listeners for row calculations
                ...
                // Specific listener for product selection to set price
