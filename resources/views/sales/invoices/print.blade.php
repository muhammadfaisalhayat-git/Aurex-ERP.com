    ...
    <div class="document-container theme-modern" id="printContainer">
        ...
        <div class="customer-section">
            ...
            <div class="customer-details">
                ...
                @if($invoice->customer?->tax_number)
                    <div>Tax Number: {{ $invoice->customer->tax_number }}</div>
                @endif
        ...
        <div class="totals-container">
            <table class="totals-table">
                ...
                <tr class="grand-total-row">
                    ...
                    <td class="total-value" style="color: #1e40af; font-size: 14pt;">{{ number_format($invoice->total_amount, 2) }}</td>
                </tr>
            </table>
        </div>
        ...
        @if($invoice->notes)
            <div style="margin-top: 40px; border-top: 1px solid #e2e8f0; padding-top: 15px;">
                ...
                <p style="white-space: pre-wrap; color: #334155; font-size: 10pt; margin-top: 5px;">{{ $invoice->notes }}</p>
            </div>
        @endif
    </div>
