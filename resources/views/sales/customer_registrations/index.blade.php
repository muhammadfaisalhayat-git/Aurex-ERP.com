...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('customer-registrations.create') }}" class="btn btn-primary">
            ...
            <div class="table-responsive">
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <a href="{{ route('customer-registrations.show', $registration) }}">
                            ...
                            <td>
                                <div class="btn-group">
                                    <a href="{{ route('customer-registrations.show', $registration) }}" class="btn btn-sm btn-info">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    @if($registration->status === 'pending')
                                        @can('customer_registration.edit')
                                        <a href="{{ route('customer-registrations.edit', $registration) }}" class="btn btn-sm btn-primary">
                                    ...
                                    @if($registration->status === 'approved' && !$registration->converted_customer_id)
                                        ...
                                        <form action="{{ route('customer-registrations.convert', $registration) }}" method="POST" class="d-inline">
                                            @csrf
                                            <button type="submit" class="btn btn-sm btn-success" onclick="return confirm('{{ __('customer_registration.confirm_convert') }}')">
