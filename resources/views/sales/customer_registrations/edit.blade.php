                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('company_name') is-invalid @enderror"
                                    ...
                                    value="{{ old('company_name', $customerRegistration->company_name) }}" required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('registration_number', $customerRegistration->registration_number) }}">
                                </div>
                            </div>
                            <div class="mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('payment_terms') is-invalid @enderror"
                                    ...
                                    value="{{ old('payment_terms', $customerRegistration->payment_terms) }}">
                            </div>
                        </div>
                    </div>
