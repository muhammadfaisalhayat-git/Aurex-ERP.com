...
@section('title', __('reports.purchase_summary_report'))

@section('content')
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3">{{ __('reports.purchase_summary_report') }}</h1>
        ...
        <div class="card-body">
            <form action="{{ route('reports.suppliers.purchase-summary') }}" method="GET">
                <div class="row">
                    <div class="col-md-3">
                        <div class="mb-3">
                            <label for="vendor_id" class="form-label">{{ __('reports.vendor') }}</label>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card mb-4">
                <div class="card-header">
                    <h5 class="mb-0">{{ __('reports.vendor_summary') }}</h5>
                </div>
                <div class="card-body">
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0">{{ __('reports.invoice_details') }}</h5>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-sm">
