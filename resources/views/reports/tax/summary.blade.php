        ...
        <div class="card-body">
            <form action="{{ route('reports.tax.summary') }}" method="GET" class="row g-3 align-items-end">
                <div class="col-md-3">
                    ...
                    <input type="date" name="date_from" class="form-control" value="{{ request('date_from', date('Y-01-01')) }}">
                </div>
                <div class="col-md-3">
                    <label class="form-label small text-muted text-uppercase fw-bold">{{ __('reports.date_to') }}</label>
                    <input type="date" name="date_to" class="form-control" value="{{ request('date_to', date('Y-12-31')) }}">
                </div>
                <div class="col-md-3">
        ...
        <div class="col-md-4">
            <div class="card border-0 shadow-sm overflow-hidden h-100">
                <div class="card-body position-relative">
                    ...
                    <h2 class="mb-0 fw-bold">SAR 0.00</h2>
                    <p class="text-muted small mb-0 mt-2">
                        <span class="text-dark fw-bold">{{ __('reports.taxable_amount') }}:</span> SAR 0.00
                    </p>
                </div>
