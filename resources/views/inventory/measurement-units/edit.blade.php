    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2 class="h4 mb-0 text-white"><i class="fas fa-edit me-2"></i>Edit Measurement Unit:
            ...
            <div class="card shadow-sm border-0 rounded-4">
                <div class="card-body p-4">
                    <form action="{{ route('inventory.measurement.units.update', $measurementUnit) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row g-4">
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control @error('code') is-invalid @enderror" id="code"
                                    name="code" value="{{ old('code', $measurementUnit->code) }}"
                            ...
                            <div class="col-md-8">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror" id="name"
                                    name="name" value="{{ old('name', $measurementUnit->name) }}"
                            ...
                            <div class="col-12 mt-4">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="is_active" name="is_active"
                                        value="1" {{ old('is_active', $measurementUnit->is_active) ? 'checked' : '' }}>
                        ...
                        <div class="d-flex justify-content-end mt-4 pt-3 border-top">
                            <button type="submit" class="btn btn-primary px-5 rounded-pill shadow-sm">
                                <i class="fas fa-save me-2"></i> Update Measurement Unit
                            </button>
                        </div>
                    </form>
                </div>
