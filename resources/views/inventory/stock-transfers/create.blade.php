...
@section('title', __('messages.create_stock_transfer'))

@section('content')
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1 class="h3">{{ __('messages.create_stock_transfer') }}</h1>
            <a href="{{ route('inventory.stock-transfers.index') }}" class="btn btn-outline-secondary">
                <i class="fas fa-arrow-left me-2"></i> {{ __('messages.back') }}
            </a>
        </div>

        <form action="{{ route('inventory.stock-transfers.store') }}" method="POST">
            @csrf
            <div class="row">
                <div class="col-lg-8">
                    <div class="card glassy mb-4">
                        <div class="card-header">
                            <h5 class="card-title mb-0">{{ __('messages.transfer_details') }}</h5>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    <label class="form-label">{{ __('messages.to_warehouse') }} <span
                                            class="text-danger">*</span></label>
                    ...
                    <div class="card glassy">
                        <div class="card-body">
                            <button type="submit" class="btn btn-primary w-100">
                                <i class="fas fa-save me-2"></i> {{ __('messages.save_transfer') }}
                            </button>
                        </div>
                    </div>
                </div>
