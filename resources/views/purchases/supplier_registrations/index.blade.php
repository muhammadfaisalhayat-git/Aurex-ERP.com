...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('supplier-registrations.create') }}" class="btn btn-primary">
            ...
            <div class="table-responsive">
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <a href="{{ route('supplier-registrations.show', $registration) }}">
                            ...
                            <td>
                                <div class="btn-group">
                                    <a href="{{ route('supplier-registrations.show', $registration) }}" class="btn btn-sm btn-info">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    @if($registration->status === 'pending')
                                        @can('supplier_registration.edit')
                                        <a href="{{ route('supplier-registrations.edit', $registration) }}" class="btn btn-sm btn-primary">
                                    ...
                                    @if($registration->status === 'approved' && !$registration->converted_vendor_id)
                                        ...
                                        <form action="{{ route('supplier-registrations.convert', $registration) }}" method="POST" class="d-inline">
                                            @csrf
                                            <button type="submit" class="btn btn-sm btn-success" onclick="return confirm('{{ __('supplier_registration.confirm_convert') }}')">
