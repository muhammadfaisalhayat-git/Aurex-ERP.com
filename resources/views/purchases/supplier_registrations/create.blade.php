...
@section('title', __('supplier_registration.create'))

@section('content')
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3">{{ __('supplier_registration.create') }}</h1>
        <a href="{{ route('supplier-registrations.index') }}" class="btn btn-secondary">
            <i class="fas fa-arrow-left"></i> {{ __('general.back') }}
        </a>
    </div>

    <form action="{{ route('supplier-registrations.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-md-6">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('products_services') is-invalid @enderror" 
                                      id="products_services" name="products_services" rows="3">{{ old('products_services') }}</textarea>
                        </div>
                    </div>
                </div>
