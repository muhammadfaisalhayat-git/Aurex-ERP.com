            ...
            <form action="{{ route('finance.vouchers.payment.store') }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text" name="payee_name" class="form-control" required placeholder="Who are you paying?">
                    </div>
                </div>
                ...
                <div class="row" id="beneficiary_container" style="display: none;">
                    <div class="col-md-12 mb-3">
                        <div class="p-3 bg-light border rounded">
                            ...
                            <div class="form-text text-primary" id="beneficiary_help">This account requires a specific entity for subsidiary ledger tracking.</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-4">
                    ...
                    <a href="{{ route('finance.vouchers.payment.index') }}" class="btn btn-link text-secondary">Cancel</a>
                </div>
            </form>
        </div>
    </div>
