                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="d-grid gap-2">
                            ...
                            @can('edit users')
                                <form action="{{ route('acp.user-mgmt.users.reset-password', $user) }}" method="POST"
                                ...
                                <form action="{{ route('acp.user-mgmt.users.toggle-status', $user) }}" method="POST">
                                    @csrf
                            ...
                            @if(!$user->isSuperAdmin() && $user->id !== auth()->id())
                                @can('delete users')
                                    <form action="{{ route('acp.user-mgmt.users.destroy', $user) }}" method="POST"
