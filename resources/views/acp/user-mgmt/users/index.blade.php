...
@section('content')
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            @can('create users')
                <a href="{{ route('acp.user-mgmt.users.create') }}" class="btn btn-primary">
                        ...
                        <tbody>
                            @forelse($users as $user)
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <a href="{{ route('acp.user-mgmt.users.show', $user) }}" class="btn btn-sm btn-info"
                                                title="{{ __('messages.view') }}">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            @can('edit users')
                                                <a href="{{ route('acp.user-mgmt.users.edit', $user) }}" class="btn btn-sm btn-primary"
