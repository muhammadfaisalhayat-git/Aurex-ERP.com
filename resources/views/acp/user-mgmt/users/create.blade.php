...
@section('content')
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1 class="h3">{{ __('messages.add_user') }}</h1>
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('acp.user-mgmt.users.store') }}" method="POST">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-control @error('default_language') is-invalid @enderror"
                                ...
                                <option value="ar" {{ old('default_language') == 'ar' ? 'selected' : '' }}>Arabic</option>
                            </select>
