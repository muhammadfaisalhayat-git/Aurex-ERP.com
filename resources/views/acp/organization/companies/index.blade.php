...
@section('content')
    <div class="page-header">
        ...
        <div class="page-actions">
            <a href="{{ route('acp.organization.companies.create') }}" class="btn btn-primary">
                    ...
                    <tbody>
                        @forelse($companies as $company)
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a href="{{ route('acp.organization.companies.edit', $company) }}"
                                            class="btn btn-sm btn-outline-primary">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <form action="{{ route('acp.organization.companies.destroy', $company) }}" method="POST"
