...
@section('content')
    <div class="page-header">
        ...
        <div class="page-actions">
            <a href="{{ route('acp.organization.companies.index') }}" class="btn btn-outline-secondary">
    ...
    <div class="card">
        <form action="{{ isset($company) ? route('acp.organization.companies.update', $company) : route('acp.organization.companies.store') }}"
