...
<head>
    ...
    <title><?php echo e(__('messages.login')); ?> - Aurex ERP</title>
    ...
    <div class="login-container">
        <div class="login-card">
            <div class="login-header">
                ...
                <p class="login-subtitle"><?php echo e(__('messages.login_subtitle')); ?></p>
            </div>
            ...
            <form method="POST" action="<?php echo e(route('login')); ?>">
                ...
                <div class="form-floating">
                    ...
                    <label for="email"><i class="fas fa-envelope me-2"></i><?php echo e(__('messages.email')); ?></label>
                </div>
                
                <div class="form-floating">
                    <input type="password" class="form-control" id="password" name="password" placeholder="Password" required>
                    <label for="password"><i class="fas fa-lock me-2"></i><?php echo e(__('messages.password')); ?></label>
                </div>
            ...
            <div class="language-switcher">
                ...
                <a href="<?php echo e(route('language.switch', 'ar')); ?>" class="<?php echo e(app()->getLocale() === 'ar' ? 'active' : ''); ?>">العربية</a>
            </div>
            
            <div class="demo-credentials">
                <h6><?php echo e(__('messages.demo_credentials')); ?></h6>
...
<?php /**PATH C:\Users\Pc\Downloads\aurex-erp\aurex-erp\resources\views/auth/login.blade.php ENDPATH**/ ?>