    ...
    <style>
        ...
        * {
        ...
        .sidebar {
            position: fixed;
            top: 0;
            <?php echo e(app()->getLocale() === 'ar' ? 'right' : 'left'); ?>: 0;
        ...
        <header class="header">
            ...
            <div class="header-right">
                ...
                <div class="language-switcher">
                    ...
                    <a href="<?php echo e(route('language.switch', 'ar')); ?>" class="<?php echo e(app()->getLocale() === 'ar' ? 'active' : ''); ?>">عربي</a>
                </div>
                ...
                <div class="dropdown user-dropdown">
                    <button class="dropdown-toggle" data-bs-toggle="dropdown">
                        ...
                        <div class="user-info d-none d-md-block">
                            ...
                            <div class="user-role"><?php echo e(auth()->user()->roles->first()?->display_name_en ?? 'User'); ?></div>
                        </div>
                        <i class="fas fa-chevron-down ms-2" style="font-size: 0.75rem; color: #64748b;"></i>
                    </button>
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li><a class="dropdown-item" href="#"><i class="fas fa-user me-2"></i><?php echo e(__('messages.profile')); ?></a></li>
                        <li><a class="dropdown-item" href="#"><i class="fas fa-cog me-2"></i><?php echo e(__('messages.settings')); ?></a></li>
...
<?php /**PATH C:\Users\Pc\Downloads\aurex-erp\aurex-erp\resources\views/layouts/app.blade.php ENDPATH**/ ?>