    ...
    <nav class="sidebar-menu">
        ...
        <?php if($checkVisibility('module_sales')): ?>
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['view customers', 'view quotations', 'view invoices', 'view returns', 'view commissions', 'view customer_registration'])): ?>
                ...
                <?php if($checkVisibility('sidebar_sales_documents')): ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['view quotations', 'view customer_registration', 'view customer_requests', 'view sales_orders', 'view sales_contracts'])): ?>
                        <div
                ...
                <?php if($checkVisibility('sidebar_commissions')): ?>
                ...
                <?php if($checkVisibility('sidebar_customer_registrations')): ?>
        ...
        <?php if($checkVisibility('module_purchases')): ?>
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['view vendors', 'view purchases', 'view local_purchase', 'view supplier_registration', 'view purchase_invoices'])): ?>
                ...
                <?php if($checkVisibility('sidebar_supply_orders')): ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['view purchases', 'view purchase_invoices'])): ?>
                        <div class="menu-item">
                        ...
                        <?php if($checkVisibility('sidebar_purchase_invoices')): ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view purchase_invoices')): ?>
                                <div class="menu-item">
                ...
                <?php if($checkVisibility('sidebar_supplier_registrations')): ?>
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['view products', 'view inventory'])): ?>
                ...
                <?php if($checkVisibility('sidebar_products')): ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view products')): ?>
                        <div
                            class="menu-item <?php echo e(request()->routeIs('inventory.products.*') || request()->routeIs('inventory.categories.*') || request()->routeIs('inventory.barcodes.*') ? 'open' : ''); ?>">
                            <a href="#" class="menu-link" data-submenu>
                ...
                <?php if($checkVisibility('sidebar_stock_management')): ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view inventory')): ?>
                        <div
                            class="menu-item <?php echo e(request()->routeIs('inventory.stock-supply.*') || request()->routeIs('inventory.stock-receiving.*') || request()->routeIs('inventory.stock-transfers.*') || request()->routeIs('inventory.transfer-requests.*') || request()->routeIs('inventory.issue-orders.*') || request()->routeIs('inventory.assemblies.*') ? 'open' : ''); ?>">
                            <a href="#" class="menu-link" data-submenu>
        ...
        <?php if($checkVisibility('module_hr')): ?>
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['view employees', 'view departments', 'view designations'])): ?>
                ...
                <div
                    class="menu-item <?php echo e(request()->routeIs('hr.*') || request()->routeIs('hr.employees.*') || request()->routeIs('hr.departments.*') || request()->routeIs('hr.designations.*') || request()->routeIs('hr.salaries.*') || request()->routeIs('hr.experience.*') ? 'open' : ''); ?>">
                    <a href="#" class="menu-link" data-submenu>
                        <i class="fas fa-users fa-fw"></i>
                    ...
                    <div class="submenu">
                        ...
                        <?php if($checkVisibility('sidebar_departments')): ?>
                            ...
                            <?php endif; ?>
                        <?php endif; ?>
                        <?php if($checkVisibility('sidebar_designations')): ?>
                        ...
                        <?php if($checkVisibility('sidebar_salaries')): ?>
                            ...
                            <?php endif; ?>
                        <?php endif; ?>
                        <?php if($checkVisibility('sidebar_experience_letters')): ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view employees')): ?>
        ...
        <?php if($checkVisibility('module_transport')): ?>
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view transport')): ?>
                ...
                <?php if($checkVisibility('sidebar_transport_claims')): ?>
                    <div class="menu-item">
        ...
        <?php if($checkVisibility('module_reports')): ?>
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view reports')): ?>
                ...
                <?php if($checkVisibility('sidebar_supplier_reports')): ?>
        ...
        <?php if($checkVisibility('module_accounting')): ?>
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view accounting')): ?>
                ...
                <div class="menu-item <?php echo e(request()->routeIs('accounting.gl.*') ? 'open' : ''); ?>">
                    <a href="#" class="menu-link" data-submenu>
                        <i class="fas fa-book fa-fw"></i>
                        <span><?php echo e(__('messages.general_ledger_system')); ?></span>
                        <i class="fas fa-chevron-down menu-arrow"></i>
                    </a>
                    <div class="submenu">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage chart of accounts')): ?>
                            <a href="<?php echo e(route('accounting.gl.coa.index')); ?>"
                                class="menu-link <?php echo e(request()->routeIs('accounting.gl.coa.*') ? 'active' : ''); ?>">
                                <?php echo e(__('messages.chart_of_accounts')); ?>

                            </a>
                        <?php endif; ?>

                        <!-- Transactions Submenu -->
                        <div class="menu-item <?php echo e(request()->routeIs('accounting.gl.transactions.*') ? 'open' : ''); ?>"
                            ...
                            <div class="submenu">
                                <a href="<?php echo e(route('accounting.gl.transactions.jv.index')); ?>"
                                    class="menu-link <?php echo e(request()->routeIs('accounting.gl.transactions.jv.*') ? 'active' : ''); ?>">
                                    <?php echo e(__('messages.journal_vouchers')); ?>
                        ...
                        <!-- Reports Submenu -->
                        <div class="menu-item <?php echo e(request()->routeIs('accounting.gl.reports.*') ? 'open' : ''); ?>"
                            style="margin-left: 10px;">
                            <a href="#" class="menu-link" data-submenu>
                                <i class="fas fa-file-invoice-dollar fa-fw"></i>
